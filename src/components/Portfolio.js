...
import foodcipe from '../assets/foodcipe.png'
  ...
  return (
    <section id="portfolio">
      ...
      className='flex flex-col text-center justify-center text-white/70 mt-44 max-w-[600px] md:max-w-[950px] mx-auto'>
        <div>
          <h1 className='text-6xl md:text-8xl font-bold pb-2'>Portfolio</h1>
        ...
        <motion.div
          ...
          whileInView={{opacity: 1, y: 0}}
          transition={{duration: 0.5, delay: 0.25}}
          className='flex flex-col md:flex-row max-w-[330px] md:max-w-[900px] items-center space-x-4 mt-20'>
        ...
        <motion.div
          ...
          whileInView={{opacity: 1, y: 0}}
          transition={{duration: 0.5, delay: 0.25}}
          className='flex flex-col md:flex-row-reverse max-w-[330px] md:max-w-[900px] items-center space-x-4 mt-20'>
          <div className='flex-1'>
              <Image
                src={portfolio}
              />
        ...
        className='flex flex-col md:flex-row max-w-[330px] md:max-w-[900px] items-center space-x-4 mt-20'>
          ...
          <div className='flex-1 p-4 text-white/70 text-left'>
            <h1 className='text-6xl pb-3'>06</h1>
            <h1 className='text-3xl pb-3 text-white'>Foodcipe</h1>
            <h1 className='pl-4 text-sm pb-5'>A mobile app with authentication where users are able to organise their food on a daily calendar for breakfast, lunch, dinner. </h1>
            <h1 className='font-bold text-orange-500'> React Native, Tailwindcss, Supabase </h1>
            <div className='border-b pt-2 max-w-[200px]'></div>
            <div>
              <a href="#" className=' text-sm text-white'>Apk</a>
              <a href="https://github.com/chukaluka/food-cipe" className='pl-5 text-sm text-white'>Git</a>
            </div>
          </div>
        </motion.div>
      </motion.div>
